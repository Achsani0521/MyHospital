...
import com.example.myhospital.ui.apotek.ShoppingCartFragment
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bottomNav.setOnItemSelectedListener { item ->
            val selectedFragment: Fragment = when (item.itemId) {
                R.id.navigation_home -> HomeFragment().apply { arguments = bundle } // Ubah agar HomeFragment juga menerima bundle
                R.id.navigation_antrian -> AntrianFragment()
                R.id.navigation_profil -> ProfilFragment().apply { arguments = bundle } // Pastikan ini ProfileFragment
                R.id.action_view_cart -> ShoppingCartFragment()
                else -> HomeFragment().apply { arguments = bundle } // Fallback
            }
